		...
		<Layout>
			<div>
				<section
					...
					style={{
						backgroundImage: 'url(img/blog/details/details-hero.jpg)'
					}}
				>
							...
							<div className="col-lg-8 col-md-7 order-md-1 order-1">
								<div className="blog__details__text">
									...
									<p>
										...
										tincidunt nibh pulvinar a. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus.
										Sed porttitor lectus nibh. Donec sollicitudin molestie malesuada. Curabitur non nulla sit amet nisl
										tempus convallis quis ac lectus. Proin eget tortor risus. Donec rutrum congue leo eget malesuada.
										Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Donec sollicitudin molestie
										malesuada. Nulla quis lorem ut libero malesuada feugiat. Curabitur arcu erat, accumsan id imperdiet
										et, porttitor at sem.
									</p>
									<h3>
										...
										<div className="col-lg-6">
											<div className="blog__details__widget">
												<ul>
													...
													<li>
														<span>Tags:</span> All, Trending, Cooking, Healthy Food, Life Style
													</li>
												</ul>
